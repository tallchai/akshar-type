...
## OpenType Variable
Akshar is an OpenType Variable Font. It offers 2 axes: Weight (`wght`) and Contrast (`CTRA`).
The **Weight** axis ranges from 300 to 700. The **Contrast** axis ranges from 0 to 60.
